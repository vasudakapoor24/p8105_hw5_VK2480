...
```
    ...
    ## 
    ## data:  a_sampl
    ## t = 24.915, df = 29, p-value < 2.2e-16
...
![](p8105_hw5_VK2480_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](p8105_hw5_VK2480_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
...
almost equal to μ as the value of μ increases. WHY???
